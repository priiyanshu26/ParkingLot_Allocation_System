...
namespace ParkingAllocationBackend.Controllers
{
    ...
    public class ParkingAllocationController : ControllerBase
    {
        ...
        public ParkingAllocationController(IParkingAllocationService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> GetAll() => Ok(await _service.GetAllAllocationsAsync());
        ...
        {
            var result = await _service.GetAllocationByIdAsync(id);
